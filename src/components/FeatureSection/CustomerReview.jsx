          ...
          <div className="flex flex-col lg:flex-row gap-6 items-stretch justify-center">
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-6 md:p-8 relative lg:w-[380px] h-auto lg:h-[400px] flex flex-col">
              ...
              <div className="absolute top-1/2 right-6">
                <Image src={whiteQuoteIcon} alt="quote icon" width={50} height={50} />
              </div>

              {/* Text */}
              <p className="text-base md:text-[18px] font-normal text-[#4A4A4A] font-inter-tight leading-relaxed ">
                "As a frequent business traveler, reliable connectivity is a must, and Simly delivers. Setting up the eSIM was quick, and I could stay connected during back-to-back trips in multiple countries.
              </p>
              ...
              <div className="flex items-center gap-3 mt-8 md:mt-20">
                ...
                <div>
                  <h4 className="text-[16px] font-inter-tight font-bold text-[#0A0A0A]">Daniel A. Rivera</h4>
                  <p className="text-[14px] font-inter-tight text-[#4A4A4A]">Art Detector</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#00C896] border border-[#00C896] rounded-3xl p-6 md:p-8 relative lg:w-[700px] h-auto lg:h-[400px] flex flex-col">
              {/* Quote Icon */}
              <div className="absolute top-1/2 right-6">
                <Image src={blackQuoteIcon} alt="quote icon" width={50} height={50} />
              </div>
              ...
              <div className="flex items-center gap-2 mb-6 md:mb-10 mt-6">
                <div className="flex gap-1">
                  {[1, 2, 3, 4].map((star) => (
                    <Image key={star} src={starIcon} alt="star icon" width={24} height={24} />
                  ))}
                  <Image src={starEmptyIcon} alt="empty star icon" width={24} height={24} />
                </div>
              ...
              <div className="flex items-center gap-3 mt-8 md:mt-20">
                ...
                <div>
                  <h4 className="text-[16px] font-inter-tight font-bold text-[#0A0A0A]">Corey C. Smith</h4>
                  <p className="text-[14px] font-inter-tight text-[#4A4A4A]">CEO & Co - Founder</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-6 md:p-8 relative lg:w-[380px] h-auto lg:h-[400px] flex flex-col">
              ...
              <div className="flex items-center gap-3 mt-8 md:mt-20">
                ...
                <div>
                  <h4 className="text-[16px] font-inter-tight font-bold text-[#0A0A0A]">Name Here</h4>
                  <p className="text-[14px] font-inter-tight text-[#4A4A4A]">Betty T. Slowik</p>
                </div>
              </div>
            </div>
