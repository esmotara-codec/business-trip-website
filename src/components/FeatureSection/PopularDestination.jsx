    ...
    <div className="bg-white py-12 md:py-16 lg:py-20">
        ...
        <div className="container w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 mb-8">
            ...
            {/* Search Bar & View All */}
            <div className="flex justify-between items-center w-full lg:w-auto lg:min-w-[725px]">
              {/* Search Bar */}
              ...
              <Link href="/destinations" >
                <button className="bg-[#00C896] text-white  rounded-full  text-[16px] font-inter-tight font-semibold flex items-center  hover:bg-[#048f6c] transition-colors whitespace-nowrap">
                 <span className="pl-6 pr-2 py-2"> View All</span>
                  <Image src={viewArrow} alt="View All" width={50} height={50} className="bg-white rounded-full" />
                </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-8 items-start">
            ...
            <div className="flex gap-5 pb-4 overflow-x-auto scrollbar-hide w-full  lg:min-w-[780px]">
              {/* New Zealand Card */}
              <div className="bg-[#00C896] min-w-[260px]  rounded-3xl p-2 md:p-6 text-white flex-shrink-0 space-y-3">
                ...
                <div className="mb-10 md:mb-24">
                  <h3 className="text-xl md:text-[28px] font-inter-tight font-semibold"> New Zealand</h3>
                  <p className="text-sm md:text-[18px]  font-inter-tight">Start from $6.92</p>
                </div>
              ...
              <div className="bg-[#006752] min-w-[260px]  rounded-3xl p-6 text-white flex-shrink-0 space-y-4">
                ...
                <div className="mb-10 md:mb-24">
                  <h3 className="text-xl md:text-[28px] font-inter-tight font-semibold">Japan</h3>
                  <p className="text-sm md:text-[18px]  font-inter-tight">Start from $6.99</p>
                </div>
              ...
              <div className="bg-[#FFB94A] min-w-[260px]  rounded-3xl p-6 text-white flex-shrink-0 space-y-4">
                ...
                <div className="mb-10 md:mb-24">
                  <h3 className="text-xl md:text-[28px] font-inter-tight font-semibold">Germany</h3>
                  <p className="text-sm md:text-[18px]  font-inter-tight">Start from $7.04</p>
                </div>
                <button className="w-full bg-white text-[#00C896] py-2 my-5 rounded-full text-sm font-semibold hover:bg-gray-100 transition-colors">
                  View Details
                </button>
